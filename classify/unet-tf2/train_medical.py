...
if __name__ == "__main__":    
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = "/root/autodl-nas/unet-tf2/model_data/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"
    #---------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = '/root/autodl-nas/unet-tf2/logs'
    
    #------------------------------------------------------------------#
    #   VOCdevkit_path  数据集路径
    #------------------------------------------------------------------#
    VOCdevkit_path  = '/root/autodl-nas/unet-tf2/Medical_Datasets'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "/root/autodl-nas/unet-tf2/Medical_Datasets/ImageSets/Segmentation/train.txt"),"r") as f:
